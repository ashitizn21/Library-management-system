$(document).ready(function() {
    ...
    // Basic DataTables
    // $('#roles_table,  #deapartment_heads_list, #lab_assistant_lists, #loan_list, #store_officers_list').DataTable({
    //     dom: "QBfltipr",
    //     responsive: true,
    //     columnDefs: [{
    //         orderable: false,
    ...
    $('[id*=_wrapper] select, [id*=_wrapper] input').addClass('w-30 form-control shadow-none')
